...
function App() {
  ...
  useEffect(() => {
    ...
    fetch(`${'https://online-todo-mathu.onrender.com'}/auth/user`, {
      credentials: 'include',
    })
  ...
  const handleGoogleSignIn = () => {
    window.location.href = `${'https://online-todo-mathu.onrender.com'}/auth/google`;
  };

  const handleLogout = () => {
    fetch(`${'https://online-todo-mathu.onrender.com'}/auth/logout`, {
      credentials: 'include',
